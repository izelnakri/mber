...
return e.replace(ee,te)},e.htmlSafe=re,e.isHTMLSafe=ne,e._resetRenderers=function(){Yr.length=0},e.renderSettled=function(){null===Qr&&(Qr=R.default.defer(),(0,f.getCurrentRunLoop)()||f.backburner.schedule("actions",null,Wr))
return Qr.promise},e.getTemplate=function(e){if(Object.prototype.hasOwnProperty.call(en,e))return en[e]},e.setTemplate=function(e,t){return en[e]=t},e.hasTemplate=function(e){return Object.prototype.hasOwnProperty.call(en,e)},e.getTemplates=function(){return en},e.setTemplates=function(e){en=e},e.setupEngineRegistry=function(e){e.optionsForType("template",{instantiate:!1}),e.register("view:-outlet",pn),e.register("template:-outlet",un),e.injection("view:-outlet","template","template:-outlet"),e.register(_.privatize`template:components/-default`,on),e.optionsForType("helper",{instantiate:!1}),e.register("helper:loc",an),e.register("component:-text-field",$),e.register("component:-checkbox",L),e.register("component:link-to",H),e.register("component:input",sn),e.register("template:components/input",ln),e.register("component:textarea",B),g.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS||e.register(_.privatize`component:-default`,I)},e.setupApplicationRegistry=function(e){e.injection("renderer","env","-environment:main"),e.register("service:-dom-builder",{create({bootOptions:e}){var{_renderMode:t}=e
switch(t){case"serialize":return E.serializeBuilder.bind(null)
case"rehydrate":return c.rehydrationBuilder.bind(null)
default:return c.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register(_.privatize`template:-root`,k),e.injection("renderer","rootTemplate",_.privatize`template:-root`),e.register("renderer:-dom",Zr),e.register("renderer:-inert",Xr),e.injection("renderer","document","service:-document")},e._registerMacros=function(e){Br.push(e)},e.capabilities=function(e,t={}){"3.4"!==e&&"3.13"!==e&&(0,l.assert)("Invalid component manager compatibility specified","3.4"===e||"3.13"===e)
var r
...
return Pr({factory:r,internal:!1,type:"component"},t)},e.getComponentManager=function(e){var t=jr(e)
return t&&!t.internal&&"component"===t.type?t.factory:void 0},e.setModifierManager=function(e,t){return Pr({factory:e,internal:!1,type:"modifier"},t)}
e.getModifierManager=Mr,e.modifierCapabilities=function(e,t={}){return!("3.13"===e)&&(0,l.assert)("Invalid modifier manager compatibility specified","3.13"===e),{disableAutoTracking:Boolean(t.disableAutoTracking)}},e.setComponentTemplate=function(e,t){return!(null!==t&&("object"==typeof t||"function"==typeof t))&&(0,l.assert)(`Cannot call \`setComponentTemplate\` on \`${(0,a.toString)(t)}\``,null!==t&&("object"==typeof t||"function"==typeof t)),!!Or.has(t)&&(0,l.assert)(`Cannot call \`setComponentTemplate\` multiple times on the same class (\`${t}\`)`,!Or.has(t)),Or.set(t,e),t},e.getComponentTemplate=xr,Object.defineProperty(e,"DOMChanges",{enumerable:!0,get:function(){return c.DOMChanges}}),Object.defineProperty(e,"DOMTreeConstruction",{enumerable:!0,get:function(){return c.DOMTreeConstruction}}),Object.defineProperty(e,"isSerializationFirstNode",{enumerable:!0,get:function(){return c.isSerializationFirstNode}}),Object.defineProperty(e,"NodeDOMTreeConstruction",{enumerable:!0,get:function(){return E.NodeDOMTreeConstruction}}),e.OutletView=e.INVOKE=e.AbstractComponentManager=e._experimentalMacros=e.InteractiveRenderer=e.InertRenderer=e.Renderer=e.SafeString=e.Helper=e.Component=e.LinkComponent=e.TextArea=e.TextField=e.Checkbox=e.templateCacheCounters=e.RootTemplate=void 0
...
function Mt({positional:e}){return"checkbox"===e.at(0).value()?"-checkbox":"-text-field"}function It({positional:e}){var t=e.at(0).value().split("."),r=t[t.length-1],n=e.at(1).value()
return!0===n?(0,y.dasherize)(r):n||0===n?String(n):""}class Dt{constructor(e){this.inner=e,this.valueTag=(0,d.createUpdatableTag)(),this.tag=(0,d.combine)([e.tag,this.valueTag])}value(){var e=this.inner.value(),t=(0,a.isObject)(e)?(0,n.tagForProperty)(e,"[]"):d.CONSTANT_TAG
return(0,d.updateTag)(this.valueTag,t),e}get(e){return this.inner.get(e)}}var Lt=e=>(e=>null==e||"function"!=typeof e.toString)(e)?"":String(e)
function Ft({positional:e}){return e.value().map(Lt).join("")}function Ut(e){var t=null
...
t=new Proxy({},{get(e,t){r(t)},set:(e,t)=>(r(t),!1),has:(e,t)=>(r(t),!1)})}return t}var $t=Ut("`fn` helper")
...
return"function"==typeof r[Ae]?r[Ae](...i,...t):n.call($t,...i,...t)}}function zt({positional:e}){var t=e.at(0).value()
...
"function"!=typeof t[Ae]?"function"!=typeof t?(r.name=t,a.send?(0,h.flaggedInstrument)("interaction.ember-action",r,()=>{a.send.apply(a,[t,...e])}):("function"!=typeof a[t]&&(0,l.assert)(`The action '${t}' did not exist on ${a}`,"function"==typeof a[t]),(0,h.flaggedInstrument)("interaction.ember-action",r,()=>{a[t].apply(a,e)}))):(0,h.flaggedInstrument)("interaction.ember-action",r,()=>{t.apply(a,e)}):(0,h.flaggedInstrument)("interaction.ember-action",r,()=>{t[Ae].apply(t,e)})}),u)}}class er{create(e,t,r,n,i){var s,o,u,{named:c,positional:d,tag:p}=r.capture()
...
r[Ae]||(e.actionName=r.value()),e.eventName=e.getEventName()}getTag(e){return e.tag}getDestroyable(e){return e}}var tr=e=>"While rendering:\n----------------\n"+e.replace(/^/gm,"  ")
class rr{constructor(e,t,r,n){this.name=e,this.ModifierClass=t,this.delegate=r,this.state={ModifierClass:t,name:e,delegate:r},this.manager=n?ir:sr}}class nr{constructor(e,t,r,n){this.element=e,this.delegate=t,this.modifier=r,this.args=n,this.tag=(0,d.createUpdatableTag)(),(0,c.registerDestructor)(this,()=>t.destroyModifier(r,n.value()))}}var ir=new class{create(e,t,r){var{delegate:n,ModifierClass:i}=t,s=r.capture(),a=t.delegate.createModifier(i,s.value())
return new nr(e,n,a,s)}getTag({args:e,tag:t}){return(0,d.combine)([t,e.tag])}install(e){var{element:t,args:r,delegate:n,modifier:i,tag:s}=e;("object"!=typeof n.capabilities||null===n.capabilities)&&(0,l.assert)("Custom modifier managers must define their capabilities using the capabilities() helper function","object"==typeof n.capabilities&&null!==n.capabilities)
var{capabilities:o}=n
if(!0===o.disableAutoTracking)(0,d.untrack)(()=>n.installModifier(i,t,r.value()))
else{var u=(0,d.track)(()=>n.installModifier(i,t,r.value()),tr(`(instance of a \`${(0,a.getDebugName)(i)}\` modifier)`));(0,d.updateTag)(s,u)}}update(e){var{args:t,delegate:r,modifier:n,tag:i}=e,{capabilities:s}=r
if(!0===s.disableAutoTracking)(0,d.untrack)(()=>r.updateModifier(n,t.value()))
else{var o=(0,d.track)(()=>r.updateModifier(n,t.value()),tr(`(instance of a \`${(0,a.getDebugName)(n)}\` modifier)`));(0,d.updateTag)(i,o)}}getDestroyable(e){return e}},sr=new class{create(){return null}getTag(){return d.CONSTANT_TAG}install(){}update(){}getDestroyable(){return null}},ar=Ut("`on` modifier"),or=(()=>{try{var e,t=document.createElement("div"),r=0
...
class lr{constructor(e,t,r){this.shouldUpdate=!0,this.owner=e,this.element=t,this.args=r,this.tag=r.tag}updateFromArgs(){var e,{args:t}=this,{once:r,passive:n,capture:i}=t.named.value()
...
var d=!1===or&&r||n
if(this.shouldUpdate)if(d)var p=this.callback=function(t){return n&&(t.preventDefault=()=>{(0,l.assert)("You marked this listener as 'passive', meaning that you must not call 'event.preventDefault()': \n\n"+c)}),!or&&r&&dr(this,s,p,e),c.call(ar,t)}
else this.callback=c.bind(ar)}}var ur=0,cr=0
function dr(e,t,r,n){cr++,or?e.removeEventListener(t,r,n):void 0!==n&&n.capture?e.removeEventListener(t,r,!0):e.removeEventListener(t,r)}function pr(e,t,r,n){ur++,or?e.addEventListener(t,r,n):void 0!==n&&n.capture?e.addEventListener(t,r,!0):e.addEventListener(t,r)}class hr{constructor(e,t){this.SUPPORTS_EVENT_OPTIONS=or,this.isInteractive=t,this.owner=e}get counters(){return{adds:ur,removes:cr}}create(e,t,r){if(!this.isInteractive)return null
var n=r.capture()
return new lr(this.owner,e,n)}getTag(e){return null===e?d.CONSTANT_TAG:e.tag}install(e){if(null!==e){e.updateFromArgs()
var{element:t,eventName:r,callback:n,options:i}=e
pr(t,r,n,i),(0,c.registerDestructor)(e,()=>dr(t,r,n,i)),e.shouldUpdate=!1}}update(e){if(null!==e){var{element:t,eventName:r,callback:n,options:i}=e
e.updateFromArgs(),e.shouldUpdate&&(dr(t,r,n,i),pr(e.element,e.eventName,e.callback,e.options),e.shouldUpdate=!1)}}getDestroyable(e){return e}}var mr={dynamicLayout:!0,dynamicTag:!1,prepareArgs:!1,createArgs:!0,attributeHook:!1,elementHook:!1,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0,wrapped:!1,willDestroy:!1},fr="model"
var gr=new class extends se{getJitDynamicLayout(e,t){var r=e.engine.lookup("template:application")(e.engine)
return g.ENV._DEBUG_RENDER_TREE&&e.environment.extra.debugRenderTree.setTemplate(e.controller,r),r}getCapabilities(){return mr}create(e,{name:t},r){var n=e.extra.owner.buildChildEngineInstance(t)
n.boot()
var i,s,a,o,l=n.factoryFor("controller:application")||(0,w.generateControllerFactory)(n,"application")
if(r.named.has(fr)&&(o=r.named.get(fr)),void 0===o)i=l.create(),s=new u.ComponentRootReference(i,e),a={engine:n,controller:i,self:s,environment:e}
else{var d=o.value()
...
class Tr{constructor(e,t){this.outletRef=e,this.env=t,this.definition=null,this.lastState=null,this.tag=e.tag}value(){var e=function(e){var t=e.value()
...
if(null!==e){var o=(t=this.outletRef,r=this.env,n=t.tag,i=new wr(t,r),(s=(0,v.dict)()).model=i,{tag:n,positional:c.EMPTY_ARGS.positional,named:{tag:n,map:s,names:["model"],references:[i],length:1,has:e=>"model"===e,get:e=>"model"===e?i:c.UNDEFINED_REFERENCE,value:()=>({model:i.value()})},length:1,value(){return{named:this.named.value(),positional:this.positional.value()}}})
a=(0,c.curry)(new ce(e),o)}return this.definition=a}get(e){return c.UNDEFINED_REFERENCE}}var Or=new WeakMap,Rr=Object.getPrototypeOf
function xr(e){for(var t=e;null!=t;){var r=Or.get(t)
if(void 0!==r)return r
t=Rr(t)}return null}var Ar,Cr,kr,Nr=new WeakMap,Sr=Object.getPrototypeOf
function Pr(e,t){return Nr.set(t,e),t}function jr(e){for(var t=e;null!=t;){var r=Nr.get(t)
if(void 0!==r)return r
t=Sr(t)}return null}function Mr(e){var t=jr(e)
return t&&!t.internal&&"modifier"===t.type?t.factory:void 0}function Ir(e){return{object:"component:"+e}}function Dr(e,t){return{source:void 0!==e?"template:"+e:void 0,namespace:t}}function Lr(e,t,r){var n=function(e,t,r){var n="component:"+e
...
return null===n&&null===s?null:{component:n,layout:s}}b.PARTIALS&&(Ar=function(e,t){if((0,l.deprecate)(`The use of \`{{partial}}\` is deprecated, please refactor the "${e}" partial to a component`,!1,{id:"ember-views.partial",until:"4.0.0",url:"https://deprecations.emberjs.com/v3.x#toc_ember-views-partial"}),null!==e){var r=Cr(t,kr(e),e)
return!Boolean(r)&&(0,l.assert)(`Unable to find partial with name "${e}"`,Boolean(r)),r}},Cr=function(e,t,r){if(b.PARTIALS){if(!r)return
...
return e.lookup("template:"+t)||e.lookup("template:"+r)}},kr=function(e){var t=e.split("/"),r=t[t.length-1]
return t[t.length-1]="_"+r,t.join("/")})
var Fr={if:function(e,t){return new u.HelperRootReference(Ht,e.capture(),t.env)},action:function(e,t){var r,{named:i,positional:s}=e,a=s.capture(),[o,l,...u]=a.references,c=l.propertyKey,p=i.has("target")?i.get("target"):o,h=function(e,t){var r,i
...
return(...s)=>Pe(e,t.value(),r.value(),n,i)(...s)}(o.value(),p,l,h,c))[Ne]=!0,new me(r,t.env)},array:function(e){return e.positional.capture()},concat:function(e,t){return new u.HelperRootReference(Ft,e.capture(),t.env)},fn:function(e,t){var r=Bt
return r=e=>Bt(e,t.env),new u.HelperRootReference(r,e.capture(),t.env)},get:function(e,t){var r=e.positional.at(0),n=e.positional.at(1)
if((0,d.isConstTagged)(n)){var i=n.value()
return null==i||""===i?c.NULL_REFERENCE:"string"==typeof i&&i.indexOf(".")>-1?ge(r,i.split(".")):r.get(String(i))}return new Vt(e.capture(),t.env)},hash:qt,log:function(e,t){return new u.HelperRootReference(Gt,e.capture(),t.env)},mut:function(e,t){var r=e.positional.at(0)
return"function"==typeof r[Ae]?r:(void 0===r[u.UPDATE_REFERENCED_VALUE]&&(0,l.assert)("You can only pass a path to mut",void 0!==r[u.UPDATE_REFERENCED_VALUE]),new ke(r,t.env))},"query-params":function(e,t){return new u.HelperRootReference(Wt,e.capture(),t.env)},readonly:function(e,t){var r=function(e){return e[Ce]||e}(e.positional.at(0))
return new Qt(r,t.env)},unbound:function(e,t){return(1!==e.positional.length||0!==e.named.length)&&(0,l.assert)("unbound helper cannot be called with multiple params or hash params",1===e.positional.length&&0===e.named.length),new me(e.positional.at(0).value(),t.env)},unless:function(e,t){return new u.HelperRootReference(Yt,e.capture(),t.env)},"-hash":qt,"-each-in":function(e){return new it(e.positional.at(0))},"-input-type":function(e,t){return new u.HelperRootReference(Mt,e.capture(),t.env)},"-normalize-class":function(e,t){return new u.HelperRootReference(It,e.capture(),t.env)},"-track-array":function(e){return new Dt(e.positional.at(0))},"-get-dynamic-var":c.getDynamicVar,"-mount":function(e,t){var r=t.env,n=e.positional.at(0),i=null
...
return r=0===e.positional.length?new u.ConstReference("main"):e.positional.at(0),new Tr(new _r(n.outletState,r),t.env)},"-assert-implicit-component-helper-argument":Pt,"-in-el-null":jt}
class Ur{constructor(e,t){this.handles=[void 0],this.objToHandle=new WeakMap,this.builtInHelpers=Fr,this.componentDefinitionCache=new Map,this.componentDefinitionCount=0,this.helperDefinitionCount=0,this.isInteractive=t,this.builtInModifiers={action:{manager:new er,state:null},on:{manager:new hr(e,t),state:null}}}lookupComponent(e,t){var r=this.lookupComponentHandle(e,t)
...
if(void 0!==r)return r
var{moduleName:n}=t,i=t.owner,s=e,a=Dr(n,undefined),o=i.factoryFor("helper:"+s,a)||i.factoryFor("helper:"+s)
...
return new he(r,e.capture(),t.env)}:null}_lookupPartial(e,t){var n=t.owner,i=Ar(e,n)(n)
...
if(void 0!==i){var s=Mr(i.class)(n)
return new rr(e,i,s,this.isInteractive)}}return r}_parseNameForNamespace(e){var t=e,r=void 0,n=e.indexOf("::")
...
if(null!==n)return n}return Lr(e,t)}(s,i,Dr(a,undefined))
...
var c=(0,h._instrumentStart)("render.getComponentDefinition",Ir,i),d=null
...
var p=o.component.class,m=jr(p)
if(null!==m&&"component"===m.type){var{factory:f}=m
m.internal?(null===o.layout&&(0,l.assert)("missing layout for internal component "+i,null!==o.layout),d=new Rt(f(s),p,r)):d=new Ot(i,o.component,f(s),void 0!==r?r:s.lookup(_.privatize`template:components/-default`)(s))}}return null===d&&(d=new He(i,o.component||s.factoryFor(_.privatize`component:-default`),r)),c(),this.componentDefinitionCache.set(n,d),d}}function $r(e){return null===e?null:[e[0].map(e=>"@"+e),e[1]]}var Br=[]
function zr(e,t,n,i){var s=i.resolver.lookupComponent(e,i.meta.referrer)
return null!==s?(0,r.staticComponent)(s,[null===t?[]:t,$r(n),r.EMPTY_BLOCKS]):r.UNHANDLED}function Vr(e,t,n,i,s){var a=s.resolver.lookupComponent(e,s.meta.referrer)
return null!==a?(0,r.staticComponent)(a,[t,$r(n),i]):(!s.meta.referrer.owner.hasRegistration("helper:"+e)&&(0,l.assert)(`A component or helper named "${e}" could not be found`,s.meta.referrer.owner.hasRegistration("helper:"+e)),(()=>{var t=s.resolver.inner.resolver,{moduleName:r,owner:n}=s.meta.referrer
...
var Jr=0
f.backburner.on("begin",(function(){for(var e=0;e<Yr.length;e++)Yr[e]._scheduleRevalidate()})),f.backburner.on("end",(function(){for(var e=0;e<Yr.length;e++)if(!Yr[e]._isValid()){if(Jr>g.ENV._RERENDER_LOOP_LIMIT)throw Jr=0,Yr[e].destroy(),new Error("infinite rendering invalidation detected")
return Jr++,f.backburner.join(null,Wr)}Jr=0,function(){if(null!==Qr){var e=Qr.resolve
...
var l=this._runtimeResolver=new Ur(e,n.isInteractive),u=new ie(l),d=this._context=(0,r.JitContext)(u);(function(e){var{inlines:t,blocks:r}=e
...
this._appendDefinition(e,(0,c.curry)(r),t)}_appendDefinition(e,t,r){var n=new me(t,this._runtime.env),i=new qr(null,c.UNDEFINED_REFERENCE),s=new Hr(e,this._runtime,this._context,this._rootTemplate,n,r,i,this._builder)
...
class Xr extends Kr{static create(e){var{document:t,env:r,rootTemplate:n,_viewRegistry:s,builder:a}=e
return new this((0,i.getOwner)(e),t,r,n,s,!1,a)}getElement(e){throw new Error("Accessing `this.element` is not allowed in non-interactive environments (such as FastBoot).")}}e.InertRenderer=Xr
class Zr extends Kr{static create(e){var{document:t,env:r,rootTemplate:n,_viewRegistry:s,builder:a}=e
...
class nn extends xt{getCapabilities(){return tn}prepareArgs(e,t){0!==t.positional.length&&(0,l.assert)("The `<Input />` component does not take any positional arguments",0===t.positional.length)
var r=t.named.capture().map
return{positional:rn,named:{__ARGS__:new u.ConstReference(r),type:t.named.get("type")}}}create(e,{ComponentClass:t,layout:r},n,i,s){!(0,d.isConstTagged)(s)&&(0,l.assert)("caller must be const",(0,d.isConstTagged)(s))
...
Pr({factory:e=>new nn(e),internal:!0,type:"component"},sn),sn.toString=()=>"@ember/component/input"
var an=J((function(e){return y.loc.apply(null,e)})),on=C({id:"RLf1peEf",block:'{"symbols":["&default"],"statements":[[18,1,null]],"hasEval":false,"upvars":[]}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/component.hbs"}}),ln=C({id:"ExnzE3OS",block:'{"symbols":["Checkbox","TextField","@__ARGS__","&attrs"],"statements":[[6,[37,2],[[30,[36,1],["-checkbox"],null],[30,[36,1],["-text-field"],null]],null,[["default"],[{"statements":[[6,[37,0],[[32,0,["isCheckbox"]]],null,[["default","else"],[{"statements":[[8,[32,1],[[17,4]],[["@target","@__ARGS__"],[[32,0,["caller"]],[32,3]]],null]],"parameters":[]},{"statements":[[8,[32,2],[[17,4]],[["@target","@__ARGS__"],[[32,0,["caller"]],[32,3]]],null]],"parameters":[]}]]]],"parameters":[1,2]}]]]],"hasEval":false,"upvars":["if","component","let"]}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/input.hbs"}}),un=C({id:"vA+C0Wde",block:'{"symbols":[],"statements":[[1,[30,[36,1],[[30,[36,0],null,null]],null]]],"hasEval":false,"upvars":["-outlet","component"]}',meta:{moduleName:"packages/@ember/-internals/glimmer/lib/templates/outlet.hbs"}}),cn="-top-level",dn="main"
class pn{constructor(e,t,r,n){this._environment=e,this.renderer=t,this.owner=r,this.template=n
var i=this.ref=new yr({outlets:{main:void 0},render:{owner:r,into:void 0,outlet:dn,name:cn,controller:void 0,model:void 0,template:n}})
this.state={ref:i,name:cn,outlet:dn,template:n,controller:void 0,model:void 0}}static extend(e){return class extends pn{static create(r){return r?super.create((0,t.assign)({},e,r)):super.create(e)}}}static reopenClass(e){(0,t.assign)(this,e)}static create(e){var{_environment:t,renderer:r,template:n}=e,s=(0,i.getOwner)(e),a=n(s)
return new pn(t,r,s,a)}appendTo(e){var t
t=this._environment.hasDOM&&"string"==typeof e?document.querySelector(e):e,(0,f.schedule)("render",this.renderer,"appendOutletView",this,t)}rerender(){}setOutletState(e){this.ref.update(e)}destroy(){}}e.OutletView=pn})),e("@ember/-internals/meta/index",["exports","@ember/-internals/meta/lib/meta"],(function(e,t){"use strict"
