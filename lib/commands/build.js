...
export default async function(defaults={
  watch: false, environment: 'development', fastboot: true
}) {
  ...
  return Promise.all([
    ...
    buildVendor(environment, { watching: defaults.watch }),
    ...
    Console.log(`${chalk.green('WATCHING')}: ${applicationName} files...`);
