...
export default async function(
  ...
  return new Promise(async (resolve) => {
    ...
    global.XMLHttpRequest = global.dom.window.XMLHttpRequest;
    global.Request = global.dom.window.Request;
    global.Response = global.dom.window.Response;
...
// if (!browser) {
//   throw new Error('PASS puppeteer browser instance to inject-browser-to-node.js');
// }
