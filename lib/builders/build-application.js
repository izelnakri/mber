...
// import sendToThread from '../utils/send-to-thread';
...
export default function(buildConfig={
  ...
  return new Promise(async (resolve, reject) => {
    ...
    lookup(`${PROJECT_ROOT}/src`, ['js', 'ts', 'hbs'], { filter: excludeTestFiles }).then((files) => {
      return global.MBER_THREAD_POOL.submit({ files, APPLICATION_NAME, projectRoot: PROJECT_ROOT }); // send-to-thread is a babel module
    }).then((contents) => {
      // console.log('cool');
