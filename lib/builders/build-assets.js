...
export default function(buildConfig={
  ...
  return new Promise(async (resolve) => {
    ...
    return Promise.all([
      ...
      memserverIsEnabled ? buildMemServer(buildConfig) : null,
      documentationIsEnabled ? buildDocumentation(buildConfig) : null,
      ...
      cliArguments.testing ? buildTests(buildConfig) : null,
