...
export default function(buildConfig={
  ...
  return new Promise(async (resolve) => {
    ...
    return Promise.all([
      ...
      buildConfig.testing ? buildTests(buildConfig) : null,
      buildConfig.testing ? fs.copy(`${VENDOR_PATH}/test-support.css`, `${projectRoot}/tmp/assets/test-support.css`) : null,
      buildConfig.testing ? fs.copy(`${VENDOR_PATH}/test-support.js`, `${projectRoot}/tmp/assets/test-support.js`) : null,
