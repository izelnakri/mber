...
export default function(buildConfig={
  ...
  return new Promise(async (resolve) => {
    ...
    return Promise.all([
      ...
      DOCUMENTATION_IS_ENABLED ? buildDocumentationCSS(buildConfig) : null,
      DOCUMENTATION_IS_ENABLED ? buildDocumentationHTML(`${projectRoot}/index.html`, buildConfig) : null,
