...
export default async function(assetMap={}, buildConfig={
  ...
  return fs.writeFile(`${projectRoot}/${distPath}/package.json`, JSON.stringify({
    dependencies: {},
    fastboot: {
      ...
      manifest: {
        appFiles: ENV.memserver && ENV.memserver.enabled ?
          [applicationPath, assetMap['assets/memserver.js']] : [applicationPath],
        htmlFile: 'index.html',
        vendorFiles: [assetMap['assets/vendor.js']]
      },
      moduleWhitelist: ['node-fetch', 'abortcontroller-polyfill/dist/cjs-ponyfill'],
      schemaVersion: 3
    }
  }, null, 2));
}
