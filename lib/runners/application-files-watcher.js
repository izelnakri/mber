...
export default async function(buildConfig={
  ...
  function buildWatchers(watcher={}) {
    Object.assign(watcher, {
      ...
      eslintRC: watch(`${projectRoot}/.eslintrc.js`, () => {
        delete require.cache[require.resolve(`${projectRoot}/.eslintrc.js`)];
        buildConfig.jsLinter = new eslint.CLIEngine(require(`${projectRoot}/.eslintrc.js`));
      })
    });
